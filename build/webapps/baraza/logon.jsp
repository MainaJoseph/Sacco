                                        ...
                                        <div class="col vc_col-sm-6 col6  col-animate-false" style="" data-effect="fade"
                                            ...
                                            <div class="col-inner" style="">
                                                ...
                                                <form method="POST" class="wpcf7-form form-signin" action="j_security_check" novalidate="novalidate">
                                                    ...
                                                    <p><h1 class="title" style="color:#8cc443;"> Login to Wemwa Self Help Group Sacco</h1></p><br>
                                                    <p><span class="wpcf7-form-control-wrap user-name">
                                                            ...
                                                            type="text" style="max-width: 60%;margin-top: 10px" autocomplete="off"></span></p>
                                                    ...
                                                    <p><span class="wpcf7-form-control-wrap password">
                                                            ...
                                                            class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                                            aria-required="true" aria-invalid="false"
                                                            type="password" style="max-width: 60%;margin-top: 10px"></span></p>
                                                    <p><span class="wpcf7-form-control-wrap password">
                                    ...
                                    <div class="col-inner" style="">
                                        <div style="" class="nz-column-text nz-clearfix "><p></p>
                                            ...
                                            <h3 style="text-align: center; font-size: 28px; line-height: 38px;">
                                                FEATURES OF <span style="color: #7fbd2e; font-weight: bold;">WEMWA SELF HELP GROUP SACCO</span>
                                            </h3>
                                ...
                                <div class="col vc_col-sm-6 col6  col-animate-false" style="" data-effect="fade"
                                    ...
                                    <div class="col-inner" style=""><h3
                                        ...
                                        <div style="" class="nz-column-text nz-clearfix "><span
                                                ...
                                                style="font-size: medium;">We are customer-centric,
    we customize the system to suit our clients needs. Through our
    innovative systems, we enable customers to maximize profit.</span></span>
                                            ...
                                            <div id="nz-box-4" class="  nz-box animate-item">
                                                <div class="nz-box-wrap">
                                                    ...
                                                    <div class="box-data"><p></p>
                                                        ...
                                                        <h3><span style="font-size: 16px; line-height: 26px;">ITS HOSTED</span>
                                                        </h3>
            ...
            <div class="footer-info-area nz-clearfix">
                <div class="container">
                    <div class="footer-copyright nz-clearfix">
                        Copyright © 2016 Baraza Sacco by <a href="http://dewcis.co.ke/" target="_blsnk">Dew CIS
